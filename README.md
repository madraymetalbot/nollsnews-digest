...
What it does:
- Sources (all free to read): The Verge, Hacker News 300+ comment threads, CNBC Tech, Ars Technica, TechCrunch, and the TLDR Tech edition
...
- Lines are written by Workers AI (free allocation) from the article text, feed text and page description; paywalled pages fall back to what is freely available (and for Hacker News stories, the top discussion comments). It also drops stories that repeat the same news. Without AI, lines fall back to the headline
